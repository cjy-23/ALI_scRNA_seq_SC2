#!/bin/bash
#SBATCH --job-name=flames_libB   # Job name
...
"/data/gpfs/projects/punim1466/analysis/cellranger_hostonly_trim/flames_2/FLAMES/src/bin/match_cell_barcode" "/data/scratch/projects/punim1068/ONT_promethion_scRNAseq/libB/" libB_match_cell_barcode B_match_cell_barcode_output "/data/gpfs/projects/punim1466/analysis/cellranger_hostonly_trim/flames_2/libB/barcodes.tsv" 2 12
echo "Complete!"
