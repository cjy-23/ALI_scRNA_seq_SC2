#!/bin/bash
#SBATCH --job-name=flames_libG   # Job name
...
"/data/gpfs/projects/punim1466/analysis/cellranger_hostonly_trim/flames_2/FLAMES/src/bin/match_cell_barcode" "/data/scratch/projects/punim1068/ONT_promethion_scRNAseq/libG/" libG_match_cell_barcode G_match_cell_barcode_output "/data/gpfs/projects/punim1466/analysis/cellranger_hostonly_trim/flames_2/libG/barcodes.tsv" 2 12
echo "Complete!"
