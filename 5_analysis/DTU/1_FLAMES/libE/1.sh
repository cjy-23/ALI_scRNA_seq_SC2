#!/bin/bash
#SBATCH --job-name=flames_libE   # Job name
...
"/data/gpfs/projects/punim1466/analysis/cellranger_hostonly_trim/flames_2/FLAMES/src/bin/match_cell_barcode" "/data/scratch/projects/punim1068/ONT_promethion_scRNAseq/libE/" libE_match_cell_barcode E_match_cell_barcode_output "/data/gpfs/projects/punim1466/analysis/cellranger_hostonly_trim/flames_2/libE/barcodes.tsv" 2 12
echo "Complete!"
