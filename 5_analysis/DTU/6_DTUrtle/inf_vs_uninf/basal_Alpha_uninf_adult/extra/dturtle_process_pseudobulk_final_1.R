#setwd("/data/gpfs/projects/punim1466/analysis/nanopore/isoform/DTU_new_no_sat_filt/Inf_vs_uninfected/secretory-Basal_Alpha_vs_uninf_adult_save/")
...
#setwd("/data/gpfs/projects/punim1466/analysis/cellranger_new_run/DTU_15/inf_vs_uninf/Basal_Alpha_uninf_adult/")
...
dturtle <- run_drimseq(counts = count_matrix, tx2gene = tx2gene, pd=newsampledata, id_col = "id",
                       ...
                       #BPPARAM = biocpar, 
                       cond_levels=c("Basal_UK_72hpi_adult_Infected",
                                     "Basal_uninfected_adult_Uninfected"))
...
dturtle <- plot_proportion_barplot(dturtle = dturtle, 
                                   ...
                                   genes=c("ENSG00000165949","ENSG00000174748","ENSG00000174444","ENSG00000067225", "ENSG00000073605","ENSG00000138085",
                                   "ENSG00000156110", "ENSG00000164548"))
...
dturtle <- plot_proportion_pheatmap(dturtle = dturtle, 
                                    ...
                                    width=15,
                                   height=10,
                                    genes=c("ENSG00000165949","ENSG00000174748","ENSG00000174444","ENSG00000067225", "ENSG00000073605","ENSG00000138085", "ENSG00000156110", "ENSG00000164548"))
