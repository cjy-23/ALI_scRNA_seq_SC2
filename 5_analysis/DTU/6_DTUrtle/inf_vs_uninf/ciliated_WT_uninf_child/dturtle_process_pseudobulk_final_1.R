...
#setwd("/data/gpfs/projects/punim1466/analysis/cellranger_new_run/DTU_15/inf_vs_uninf/ciliated_WT_uninf_child/")
...
dturtle <- run_drimseq(counts = count_matrix, tx2gene = tx2gene, pd=newsampledata, id_col = "id",
                       ...
                       #BPPARAM = biocpar, 
                       cond_levels=c("Ciliated_VIC01_72hpi_child_Infected",
