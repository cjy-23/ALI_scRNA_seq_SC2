#setwd("/data/gpfs/projects/punim1466/analysis/nanopore/isoform/DTU_new_no_sat_filt/Inf_vs_uninfected/secretory-Cycling_basal_Alpha_vs_uninf_child_save/")
...
#setwd("/data/gpfs/projects/punim1466/analysis/cellranger_new_run/DTU_15/inf_vs_uninf/Cycling_basal_Alpha_uninf_child/")
...
dturtle <- run_drimseq(counts = count_matrix, tx2gene = tx2gene, pd=newsampledata, id_col = "id",
                       ...
                       #BPPARAM = biocpar, 
                       cond_levels=c("Cycling_basal_VIC01_72hpi_child_Infected",
                                     "Cycling_basal_uninfected_child_Uninfected"))
