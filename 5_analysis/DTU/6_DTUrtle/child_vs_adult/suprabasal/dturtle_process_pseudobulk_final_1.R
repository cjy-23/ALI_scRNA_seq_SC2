#setwd("/data/gpfs/projects/punim1466/analysis/nanopore/isoform/DTU_new_no_sat_filt/Inf_vs_uninfected/secretory-Suprbasal_Alpha_vs_uninf_adult_save/")
...
#setwd("/data/gpfs/projects/punim1466/analysis/cellranger_new_run/DTU_15/inf_vs_uninf/Suprbasal_Alpha_uninf_adult/")
...
dturtle <- run_drimseq(counts = count_matrix, tx2gene = tx2gene, pd=newsampledata, id_col = "id",
                       ...
                       cond_levels=c("Suprabasal_UK_72hpi_child_Infected",
                                     "Suprabasal_UK_72hpi_adult_Infected"))
