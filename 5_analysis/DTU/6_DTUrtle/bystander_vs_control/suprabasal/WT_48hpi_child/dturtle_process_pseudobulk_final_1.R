#setwd("/data/gpfs/projects/punim1466/analysis/nanopore/isoform/DTU_new_no_sat_filt/Inf_vs_uninfected/Suprabasal-Basal_Alpha_vs_uninf_child_save/")
...
dturtle <- run_drimseq(counts = count_matrix, tx2gene = tx2gene, pd=newsampledata, id_col = "id",
                       ...
                       #BPPARAM = biocpar, 
                       cond_levels=c("Suprabasal_VIC01_48hpi_child_Uninfected",
