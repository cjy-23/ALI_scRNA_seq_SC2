#setwd("/data/gpfs/projects/punim1466/analysis/nanopore/isoform/DTU_new_no_sat_filt/Inf_vs_uninfected/secretory-Deuterosomal_Alpha_vs_uninf_adult_save/")
...
#setwd("/data/gpfs/projects/punim1466/analysis/cellranger_new_run/DTU_15/inf_vs_uninf/Deuterosomal_Alpha_uninf_adult/")
...
dturtle <- run_drimseq(counts = count_matrix, tx2gene = tx2gene, pd=newsampledata, id_col = "id",
                       ...
                       #BPPARAM = biocpar, 
                       cond_levels=c("Deuterosomal_uninfected_child_Uninfected",
                                     "Deuterosomal_uninfected_adult_Uninfected"))
