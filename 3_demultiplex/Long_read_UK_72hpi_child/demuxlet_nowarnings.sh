...
demuxlet --sam "/analysis/cellranger_new_run/run/Long_read_UK_72hpi_child/outs/possorted_genome_bam_hg19.sorted.bam" --tag-group CB --tag-UMI UB --vcf "/genotyping/child/SNP_genotyping/plink_input/newfile_clean_3_chr_no0_lex.vcf.gz" --field GT --geno-error 0.01 --out Long_read_UK_72hpi_child_nowarning --group-list "/analysis/cellranger_new_run/run/Long_read_UK_72hpi_child/outs/filtered_feature_bc_matrix/barcodes.tsv.gz"
